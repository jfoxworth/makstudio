    ...
    !function(e, i) {
        ...
        return n = function() {
            function t(t, i) {
                ...
                this.$element.on("switchChange.bootstrapSwitch", function(i) {
                    return function(n) {
            ...
            t.prototype.state = function(t, i) {
                ...
                t = !!t,
                this.$element.prop("checked", t).trigger("change.bootstrapSwitch", i),
                this.$element)
            }
            ,
            ...
            t.prototype._elementHandlers = function() {
                return this.$element.on({
                    ...
                    "previousState.bootstrapSwitch": function(t) {
                        return function(e) {
                            return t.options = t.prevOptions,
                            t.options.indeterminate && t.$wrapper.addClass(t.options.baseClass + "-indeterminate"),
                            t.$element.prop("checked", t.options.state).trigger("change.bootstrapSwitch", !0)
                        }
                    }(this),
