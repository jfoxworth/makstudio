<div class="section mt-2 nobg">
	...
	<div class="container">
		...
		<div class="col-md-8 offset-2 center">
			<h2 class="text-title-light text-dark mb-5 ls1 uppercase">We handle all steps</h2>
		</div>
		...
		<div class="row">
			...
			<div class="col_one_third center">
				...
				<div class="center"><img src="https://makstudio.s3.us-east-2.amazonaws.com/steps1.png" width="150px"></div>
