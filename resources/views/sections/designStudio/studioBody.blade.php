<div class="container clearfix">
				...
				<div id="backlitSection">
					...
					<div id="backlitLogo" class="parameterSet">
						...
						<div class="bottommargin" style="margin:20px 0px;">
							...
							<input id="uploadLogo" name="logoUpload" type="file" multiple class="file-loading" data-show-preview="false" id="logoUpload">
						</div>
	...
	<div class="col_last col_three_fourth notopmargin nobottommargin">
		...
		<div class="topmargin row"><i class="h4 icon-file"></i>  <div id="modelName" style="font-size:24px; margin-left:10px">Unsaved Model</div></div>
	</div>
