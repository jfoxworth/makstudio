...
<section id="brandSection" class="section nomargin nopadding" style="background-color:#FFFFFF">
	...
	<div class="container clearfix">
		...
		<div class="col_two_third col_last">
			...
			<div class="sectionText">Ramada’s renovation of an historic hotel in central Austin provided an opportunity to add warm materials to a space in a new way for depth, movement and interest.</div>
