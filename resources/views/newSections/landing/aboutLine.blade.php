		...
		<div class="container clearfix">
			...
			<div class="col_half">
				...
				<div class="aboutSection">
					...
					<div class="aboutButton"><a class="underLined" href="/aboutUs">Learn More</a></div>
			...
			<div class="col_half col_last center">
				...
				<div class="col_half aboutMe aboutImage" style="margin-left:10%; margin-top:10%;">
					...
					<div class="col aboutName">
						<div class="boldName">Jose Aguilar</div>, AIA<br>
						Co-Founder<br>
						<a class="" href="mailto:jose@makstudio.us">jose@makstudio.us</a>
					</div>

					<div class="col underLined" style="margin-left:10px"></div>
				...
				<div class="col_half col_last aboutMe aboutImage"  style="margin-left:30%; margin-top:10%;">
					...
					<div class="col aboutName">
						<div class="boldName">Liz Cordill</div>, AIA<br>
						Co-Founder<br>
						<a class="" href="mailto:liz@makstudio.us">liz@makstudio.us</a>
					</div>
